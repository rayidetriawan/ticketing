! function() {
  ...
  function b() {
    var o, e, t = document.documentElement.getAttribute("data-layout"),
      ...
      a = JSON.parse(a);
    !a || "twocolumn" != t && "twocolumn" != a["data-layout"] || (document.querySelector(".navbar-menu").innerHTML = i, (o = document.createElement("ul")).innerHTML = '<a href="#" class="logo"><img src="assets/images/logo-sm.png" alt="" height="30"></a>', document.getElementById("navbar-nav").querySelectorAll(".menu-link").forEach(function(e) {
