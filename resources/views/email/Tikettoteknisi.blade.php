                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr
                                    ...
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        Kamu telah ditugaskan mengerjakan tiket dengan id {{ $details['id_tiket'] }}.
                                        <br>
                                        Segera lihat detail tiket dan mulai mengerjakannya!
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" style="font-size:0px;padding:25px 25px;padding-bottom:40px;word-break:break-word;">
                                        <a href="http://127.0.0.1:8000/ticket/assigmentTicket" target="_blank">

                                            <button class="button button1">My Assigment</button>
                                        </a>
