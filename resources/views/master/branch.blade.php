                            ...
                            <div class="col-xxl-12">
                                <div>
                                    <label for="validationCustom02"
                                        ...
                                        class="form-control @error('nama_branch') is-invalid @enderror" id="validationCustom04"
                                        autocomplete="off">
                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="sort" data-sort="email">Nama Branch</th>
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" data-v-cd5f1dea=""
                                                        ...
                                                        <li data-v-cd5f1dea="">
                                                            <a class="dropdown-item remove-item-btn confirm-delete"
                                                                ...
                                                                Delete
                                                                <form method="POST"
                                                                    action="{{ route('branch.hapus', $item->id) }}"
                                                                    id="delete-{{ $item->id }}">
                                                                    @csrf
                                                                    @method('delete')
                                                                </form>
