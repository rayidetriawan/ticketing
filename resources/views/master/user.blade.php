                    ...
                    <form action="{{ route('user.simpan') }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-xxl-12">
                                <div>
                                    <label for="validationCustom04"
                                        class="form-label @error('nik') text-danger @enderror">Nama Karyawan</label>
                                    <select class="form-control" data-choices name="nik" id="choices-single-default">
                                        <option value="">Pilih Karyawan</option>
                                        @foreach($karyawan as $kry)
                                            <option value="{{ $kry->nik }}" @if(old('nik') == $kry->nik) selected @endif>{{ $kry->nama }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-xxl-12">
                                <div>
                                    <label for="validationCustom04"
                                        class="form-label @error('level') text-danger @enderror">Level</label>
