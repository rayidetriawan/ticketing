...
@section('nav_active_kondisi','active')
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalgridLabel">Tambah Kondisi</h5>
                            ...
                            <div class="col-xxl-6">
                                <div>
                                    <label for="validationCustom04"
                                        class="form-label @error('nama_kondisi') text-danger @enderror">Kondisi</label>
                            ...
                            <div class="col-xxl-6">
                                <div>
                                    <label for="validationCustom02"
                                        class="form-label @error('waktu_respon') text-danger @enderror">Waktu respon</label>
                                    <input type="text" name="waktu_respon" value="{{ old('waktu_respon') }}"
                                        class="form-control @error('waktu_respon') is-invalid @enderror"
                                        id="validationCustom02" autocomplete="off">
                                    @error('waktu_respon')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
    ...
    <div class="modal fade" id="modaledit" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-hidden="true"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalgridLabel">Edit Kondisi</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('update.kondisi') }}" method="POST">
                        @csrf
                        ...
                        <div class="row g-3">
                            <div class="col-xxl-6">
                                <div>
                                    <label for="validationCustom04"
                                        class="form-label @error('edit_nama_kondisi') text-danger @enderror">Kondisi
                                        </label>
                                    <input type="text" name="edit_nama_kondisi" id="edit_nama_kondisi"
                                        value="{{ old('edit_nama_kondisi') }}"
                                        class="form-control @error('edit_nama_kondisi') is-invalid @enderror"
                                        id="validationCustom04" autocomplete="off">
                                    @error('edit_nama_kondisi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    @enderror
                            ...
                            <div class="col-xxl-6">
                                <div>
                                    <label for="validationCustom02"
                                        class="form-label @error('edit_waktu_respon') text-danger @enderror">Waktu Respon
                                    </label>
                                    <input type="text" name="edit_waktu_respon" id="edit_waktu_respon"
                                        value="{{ old('edit_waktu_respon') }}"
                                        class="form-control @error('edit_waktu_respon') is-invalid @enderror"
                                        id="validationCustom02" autocomplete="off">
                                    @error('edit_waktu_respon')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    @enderror
                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="sort" data-sort="phone">Waktu Respon</th>
                            ...
                            <tbody class="list form-check-all" id="carirow">
                                @foreach ($data as $no => $item)
                                    <tr>
                                        ...
                                        <td class="customer_name">{{ $item->nama_kondisi }}</td>
                                        <td class="email">{{ $item->waktu_respon }} Hari</td>
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" data-v-cd5f1dea=""
                                                        ...
                                                        <li data-v-cd5f1dea="">
                                                            <a class="dropdown-item remove-item-btn confirm-delete"
                                                                ...
                                                                Delete
                                                                <form method="POST"
                                                                    action="{{ route('hapus.kondisi', $item->id) }}"
                                                                    id="delete-{{ $item->id }}">
                                                                    @csrf
                                                                    @method('delete')
                                                                </form>
    ...
    <script>
        $(document).on('click', '.edit', function() {
            ...
            $.get(url + id + '/edit', function(data) {
                ...
                console.log(data);
                $('#id').val(data.id);
                $('#edit_nama_kondisi').val(data.nama_kondisi);
                $('#edit_waktu_respon').val(data.waktu_respon);
